...
DIRVER="GA01.1"
VER="SECN-6-AR750-RACHEL-"$DIRVER


echo "************************************"
echo ""
echo "Build script for AR750 RACHEL device"
...
build_ar750 AR750 RACHEL

echo " "
echo " Build script AR750 RACHEL complete"
echo " "
echo '----------------------------'
