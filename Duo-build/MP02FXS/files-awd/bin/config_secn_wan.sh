...
if [ $MESH_DISABLE = "0" ] && [ $DUOMODE = "Pri_AP_Mesh" ]; then
  uci set wireless.ah_0.disabled='0'
  uci set wireless.ah_1.disabled='1'
elif [ $MESH_DISABLE = "0" ] && [ $DUOMODE = "Pri_AP..Sec_Mesh" ]; then
  uci set wireless.ah_0.disabled='1'
  uci set wireless.ah_1.disabled='0'
elif [ $MESH_DISABLE = "0" ] && [ $DUOMODE = "Pri_Mesh..Sec_AP" ]; then
  uci set wireless.ah_0.disabled='0'
  uci set wireless.ah_1.disabled='1'
else  # Make sure both adhoc interfaces are disabled
	uci set wireless.ah_0.disabled='1'
	uci set wireless.ah_1.disabled='1'
fi
