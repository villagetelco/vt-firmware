...
sleep 2
svn checkout --revision=41120 svn://svn.openwrt.org/openwrt/branches/attitude_adjustment/ $OPENWRT_PATH  > $OPENWRT_PATH/checkout.log
echo " "
...
echo "src-svn packages svn://svn.openwrt.org/openwrt/branches/packages_12.09@41120" > $OPENWRT_PATH/feeds.conf.default
