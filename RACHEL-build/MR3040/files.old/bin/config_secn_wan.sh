...
# Set default LAN port to eth99
uci set network.lan.ifname='eth99'  # This is just a dummy
...
if [ $WANPORT = "Mesh" ]; then
	uci set network.wan.type='bridge' # Reqd. See also /etc/init.d/set-mesh-gw-mode
